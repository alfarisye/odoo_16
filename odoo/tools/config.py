...
class configmanager(object):
    def __init__(self, fname=None):
        ...
        group.add_option("--longpolling-port", dest="gevent-port", my_default=0,
    ...
    def _parse_config(self, args=None):
        ...
        keys = ['gevent_port', 'http_interface', 'http_port', 'gevent-port', 'http_enable', 'x_sendfile',
